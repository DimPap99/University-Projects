...
public class Message_proedrou extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView t = (TextView) findViewById(R.id.strategy_link);
        ...
        expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
            ...
            public void onGroupExpand(int groupPosition) {
                if(expandableListTitle.get(groupPosition)=="ΚΕΝΤΡΙΚΗ"){
                    Intent intent = new Intent(Message_proedrou.this, MainActivity.class);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if(expandableListDetail.get(
                    ...
                    Intent intent = new Intent(Message_proedrou.this, Message_proedrou.class);
                    startActivity(intent);
                }else if(expandableListDetail.get(
                        expandableListTitle.get(groupPosition)).get(
                        childPosition) == "Τομείς έρευνας") {
                    Intent intent = new Intent(Message_proedrou.this, tomeis_ereunas.class);
                    startActivity(intent);
                }else if(expandableListDetail.get(
                        expandableListTitle.get(groupPosition)).get(
                        childPosition) == "Επιλεγμένες δημοσιεύσεις") {
                    Intent intent = new Intent(Message_proedrou.this, epilegmenes_dimosieuseis.class);
                    startActivity(intent);
                }else if(expandableListDetail.get(
                        expandableListTitle.get(groupPosition)).get(
                        childPosition) == "Ερευνητικά έργα") {
                    Intent intent = new Intent(Message_proedrou.this, ereunitika_erga.class);
                    startActivity(intent);
                }else if(expandableListDetail.get(
                        expandableListTitle.get(groupPosition)).get(
                        childPosition) == "Ερευνητικά εργαστήρια") {
                    Intent intent = new Intent(Message_proedrou.this, ereunitika_ergastiria.class);
                    startActivity(intent);
                }
                return false;
            }
