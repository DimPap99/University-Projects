...
namespace proairetiki4
{
    public partial class PLOIGISI : Form
    {
        ...
        private void saveButton_Click(object sender ,EventArgs e) {
            if (buttonsExist == true) {
                contact editContact = new contact();
                Form1
                editContact.addOnoma(onomaTextbox.Text);
                editContact.addEpitheto(epithetoTextbox.Text);
                editContact.addKatoikia(katoikiaTextbox.Text);
                editContact.addThlefwno(tilefwnoTextbox.Text);
                editContact.addEmail(emailTextbox.Text);
                editContact.addDate(dateTimePicker.Text.ToString());
